...
<body>
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4">
                <form method="post" action="successful_student.php">
                    ...
                    <div  class="form-group">
                        <label for="stu_fathers_name">Student Fathers Name</label>
                        <input type="text" class="form-control" name="stu_fathers_name">
                    </div>
                    <div  class="form-group">
                        <label for="stu_mothers_name">Student Mothers Name</label>
                        <input type="text" class="form-control" name="stu_mothers_name">
                    </div>
                    <div  class="form-group">
                    ...
                    <div  class="form-group">
                        <label for="degree_name">Branch</label>
